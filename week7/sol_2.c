...
void check(){
    ...
    if((placed[0] == placed[1] && placed[0] == placed[2]) ||
       (placed[3] == placed[4] && placed[4] == placed[5]) ||
       (placed[6] == placed[7] && placed[7] == placed[8]))
    {
        win = 1;
    }
    //check if someone win with verticle mark
    if((placed[0] == placed[3] && placed[3] == placed[6]) ||
       (placed[1] == placed[4] && placed[4] == placed[7]) ||
       (placed[2] == placed[5] && placed[5] == placed[8]))
    {
        win = 1;
    }
